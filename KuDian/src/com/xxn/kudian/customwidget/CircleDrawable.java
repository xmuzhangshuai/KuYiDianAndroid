package com.xxn.kudian.customwidget;
...
/** 
 * 类描述 ：圆形图片
 * 类名： CircleDrawable.java  
 * Copyright:   Copyright (c)2015    
 * Company:     zhangshuai   
 * @author:     zhangshuai    
 * @version:    1.0    
 * 创建时间:    2015-8-7 下午3:48:30  
*/
public class CircleDrawable extends Drawable {
	...
	public void computeRadius() {
		Rect bounds = getBounds();
		radius = bounds.width() < bounds.height() ? bounds.width() / 2F - margin : bounds.height() / 2F - margin;
	}
}
